...
mutation_file = "backend/data/brca_tcga_mutations.json"
clinical_file = "backend/data/brca_tcga_clinical_data.json"
output_file = "backend/data/merged_mutation_clinical.json"
